...
- **2025/09/22**: We release [***UniSE***](https://github.com/alibaba/unified-audio/tree/main/QuarkAudio-UniSE), a foundation model for unified speech generation. The system supports target speaker extraction, universal speech enhancement. [![arXiv](https://img.shields.io/badge/arXiv-Paper-COLOR.svg)](https://arxiv.org/abs/2510.20441). Pretrained weights and inference examples are available.
