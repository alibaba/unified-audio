...
from model import Model_stereo as Model
...
def main(args):
    ...
    save_dir = args.output_dir or './output_stereo'
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('HCodec Stereo Inference')
    parser.add_argument('--config', type=str, default='./conf/config_base_stereo.yaml')
    parser.add_argument('--ckpt_path', type=str, default=None, help='Path to checkpoint')
    parser.add_argument('--input_dir', type=str, default=None, help='Directory containing input wav files')
